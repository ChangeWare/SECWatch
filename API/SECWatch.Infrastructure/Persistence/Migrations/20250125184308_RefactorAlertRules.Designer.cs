...
namespace SECWatch.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250125184308_RefactorAlertRules")]
    partial class RefactorAlertRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SECWatch.Domain.Features.Companies.Models.CompanyUserDashboardPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PinnedConcepts")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("CompanyUserDashboardPreferences", (string)null);
                });
            ...
            modelBuilder.Entity("SECWatch.Domain.Features.Alerts.Models.FilingAlertNotification", b =>
                {
                    b.HasOne("SECWatch.Domain.Features.Alerts.Models.AlertRule", "FilingAlertRule")
                        .WithMany()
